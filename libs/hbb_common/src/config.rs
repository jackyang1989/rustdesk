...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "YUhao@8912".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["8.134.65.123"];
pub const PUBLIC_RS_PUB_KEY: &str = "1vuRT+W0MtuJZypqOHvrBhVUpqnj+U408mHHVJ7Ve3M=";
